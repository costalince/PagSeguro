...
class PagSeguro_Log_Log{
	...
	public static function init() {
		if (self::$log == null) {
			self::$log = new PagSeguro_Log_Log();
		}
		return self::$log;
	}
	
	public static function reLoad() {
		self::$active = PagSeguro_Config_Config::logIsActive();
		if (self::$active) {
			$fileLocation = PagSeguro_Config_Config::getLogFileLocation();
	...
	public static function createFile() {
		...
		$defaultPath   = PagSeguro_Library::getPath();
