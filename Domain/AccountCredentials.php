...
* /
*/
class PagSeguro_Domain_AccountCredentials extends PagSeguro_Domain_Credentials{
	...
	*/
	...
	/**
	* Initializes a new instance of the PagSeguro_Domain_AccountCredentials class
	*
	* @param email
	* @param token
	*/
