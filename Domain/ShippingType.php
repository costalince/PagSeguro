...
*/	
class PagSeguro_Domain_ShippingType {
	...
	/**
	 * @param value
	 * @return the PagSeguro_Domain_ShippingType corresponding to the informed value
	*/
	...
	/**
	 * @param type
	 * @return a PagSeguro_Domain_ShippingType object corresponding to the informed type
	*/
	public static function createByType($type){
		$ShippingType = new PagSeguro_Domain_ShippingType();
