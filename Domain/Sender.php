...
class PagSeguro_Domain_Sender {
	...
	public function __construct(Array $data = null) {
		if ($data) {
			...
			if (isset($data['phone']) && $data['phone'] instanceof PagSeguro_Domain_Phone) {
				$this->phone = $data['phone'];
			} else if (isset($data['areaCode']) && isset($data['number'])) {
				$phone = new PagSeguro_Domain_Phone($data['areaCode'], $data['number']);
				$this->phone = $phone;
			}
		}
	}
