 ...
 * */
class PagSeguro_Exception_ServiceException extends Exception{

	private $httpStatus;
	private $httpMessage;
	private $errors = Array();
	
	public function __construct(PagSeguro_Domain_HttpStatus $httpStatus, Array $errors = null) {
	...
	public function setHttpStatus(PagSeguro_Domain_HttpStatus $httpStatus){
		$this->httpStatus = $httpStatus;
	}
	...
	public function getFormatedMessage(){
		...
		foreach ($this->errors as $key => $value) {
			if ($value instanceof PagSeguro_Domain_Error) {
