...
class PagSeguro_Resources_Resources{
	...
	private function __construct() {
		...
		require_once PagSeguro_Library::getPath().DIRECTORY_SEPARATOR."Resources".DIRECTORY_SEPARATOR."Ini.php";
	...
	public static function init() {
		if (self::$resources == null) {
			self::$resources = new PagSeguro_Resources_Resources();
		}
