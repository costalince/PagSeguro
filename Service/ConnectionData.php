...
class PagSeguro_Service_ConnectionData{
	...
	public function __construct(PagSeguro_Domain_Credentials $credentials, $serviceName) {
	
		$this->credentials = $credentials;
		$this->serviceName = $serviceName;
	
		$this->setEnvironment(PagSeguro_Config_Config::getEnvironment());
		$this->setWebserviceUrl(PagSeguro_Resources_Resources::getWebserviceUrl($this->getEnvironment()));
		$this->setCharset(PagSeguro_Config_Config::getApplicationCharset());
	
		$this->resources = PagSeguro_Resources_Resources::getData($this->serviceName);
	...
	public function setCredentials(PagSeguro_Domain_Credentials $credentials) {
		$this->credentials = $credentials;
	}
